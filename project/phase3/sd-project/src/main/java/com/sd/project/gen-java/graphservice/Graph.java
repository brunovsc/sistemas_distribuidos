...
public class Graph {
  ...
  public interface Iface {
    ...
    public boolean createAresta(int vertice1, int vertice2, double peso, boolean direcionado, String descricao) throws KeyAlreadyUsed, ResourceInUse, KeyNotFound, BadParameter, org.apache.thrift.TException;

    public boolean deleteAresta(int vertice1, int vertice2) throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException;

    public boolean updateAresta(int vertice1, int vertice2, double peso, boolean direcionado, String descricao) throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException;

    public Aresta readAresta(int vertice1, int vertice2) throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException;

    public List<Vertice> listVerticesFromAresta(int vertice1, int vertice2) throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException;
    ...
    public List<Vertice> menorCaminho(int vertice1, int vertice2) throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException;

    public boolean deleteArestasFromVertice(int vertice) throws KeyNotFound, ResourceInUse, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void deleteArestasFromVertice(int vertice, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<Vertice> recv_listVerticesFromAresta() throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException
    {
    ...
    public List<Vertice> recv_menorCaminho() throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException
    {
    ...
    public boolean deleteArestasFromVertice(int vertice) throws KeyNotFound, ResourceInUse, org.apache.thrift.TException
    {
      send_deleteArestasFromVertice(vertice);
      return recv_deleteArestasFromVertice();
    }

    public void send_deleteArestasFromVertice(int vertice) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class createAresta_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public boolean getResult() throws KeyAlreadyUsed, ResourceInUse, KeyNotFound, BadParameter, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class deleteAresta_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public boolean getResult() throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class listVerticesFromAresta_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<Vertice> getResult() throws KeyNotFound, ResourceInUse, BadParameter, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void deleteArestasFromVertice(int vertice, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      deleteArestasFromVertice_call method_call = new deleteArestasFromVertice_call(vertice, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class deleteArestasFromVertice_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int vertice;
      public deleteArestasFromVertice_call(int vertice, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
...
*/
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class deleteArestasFromVertice<I extends Iface> extends org.apache.thrift.ProcessFunction<I, deleteArestasFromVertice_args> {
      ...
      public deleteArestasFromVertice_result getResult(I iface, deleteArestasFromVertice_args args) throws org.apache.thrift.TException {
        deleteArestasFromVertice_result result = new deleteArestasFromVertice_result();
        try {
          result.success = iface.deleteArestasFromVertice(args.vertice);
          result.setSuccessIsSet(true);
        } catch (KeyNotFound knf) {
          result.knf = knf;
        } catch (ResourceInUse riu) {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class deleteArestasFromVertice<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, deleteArestasFromVertice_args, Boolean> {
      public deleteArestasFromVertice() {
        super("deleteArestasFromVertice");
      }
      ...
      public void start(I iface, deleteArestasFromVertice_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
        iface.deleteArestasFromVertice(args.vertice,resultHandler);
      }
    }
  ...
  public static class createAresta_result implements org.apache.thrift.TBase<createAresta_result, createAresta_result._Fields>, java.io.Serializable, Cloneable, Comparable<createAresta_result>   {
    ...
    public int compareTo(createAresta_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetBp()).compareTo(other.isSetBp());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetBp()) {
...
;
  ...
  public static class deleteArestasFromVertice_args implements org.apache.thrift.TBase<deleteArestasFromVertice_args, deleteArestasFromVertice_args._Fields>, java.io.Serializable, Cloneable, Comparable<deleteArestasFromVertice_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new deleteArestasFromVertice_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new deleteArestasFromVertice_argsTupleSchemeFactory());
    }
    ...
    public deleteArestasFromVertice_args setVertice(int vertice) {
      this.vertice = vertice;
      setVerticeIsSet(true);
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("deleteArestasFromVertice_args(");
      boolean first = true;
    ...
    private static class deleteArestasFromVertice_argsStandardSchemeFactory implements SchemeFactory {
      public deleteArestasFromVertice_argsStandardScheme getScheme() {
        return new deleteArestasFromVertice_argsStandardScheme();
      }
    }

    private static class deleteArestasFromVertice_argsStandardScheme extends StandardScheme<deleteArestasFromVertice_args> {
    ...
    private static class deleteArestasFromVertice_argsTupleSchemeFactory implements SchemeFactory {
      public deleteArestasFromVertice_argsTupleScheme getScheme() {
        return new deleteArestasFromVertice_argsTupleScheme();
      }
    }

    private static class deleteArestasFromVertice_argsTupleScheme extends TupleScheme<deleteArestasFromVertice_args> {
  ...
  public static class deleteArestasFromVertice_result implements org.apache.thrift.TBase<deleteArestasFromVertice_result, deleteArestasFromVertice_result._Fields>, java.io.Serializable, Cloneable, Comparable<deleteArestasFromVertice_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new deleteArestasFromVertice_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new deleteArestasFromVertice_resultTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("deleteArestasFromVertice_result(");
      boolean first = true;
    ...
    private static class deleteArestasFromVertice_resultStandardSchemeFactory implements SchemeFactory {
      public deleteArestasFromVertice_resultStandardScheme getScheme() {
        return new deleteArestasFromVertice_resultStandardScheme();
      }
    }

    private static class deleteArestasFromVertice_resultStandardScheme extends StandardScheme<deleteArestasFromVertice_result> {
    ...
    private static class deleteArestasFromVertice_resultTupleSchemeFactory implements SchemeFactory {
      public deleteArestasFromVertice_resultTupleScheme getScheme() {
        return new deleteArestasFromVertice_resultTupleScheme();
      }
    }

    private static class deleteArestasFromVertice_resultTupleScheme extends TupleScheme<deleteArestasFromVertice_result> {
