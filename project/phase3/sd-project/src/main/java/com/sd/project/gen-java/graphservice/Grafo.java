            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arestas = new ArrayList<Aresta>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  Aresta _elem2;
                  _elem2 = new Aresta();
                  _elem2.read(iprot);
                  struct.arestas.add(_elem2);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vertices = new ArrayList<Vertice>(_list3.size);
                for (int _i4 = 0; _i4 < _list3.size; ++_i4)
                {
                  Vertice _elem5;
                  _elem5 = new Vertice();
                  _elem5.read(iprot);
                  struct.vertices.add(_elem5);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.arestas = new ArrayList<Aresta>(_list10.size);
          for (int _i11 = 0; _i11 < _list10.size; ++_i11)
          {
            Aresta _elem12;
            _elem12 = new Aresta();
            _elem12.read(iprot);
            struct.arestas.add(_elem12);
          }
        }
        struct.setArestasIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.vertices = new ArrayList<Vertice>(_list13.size);
